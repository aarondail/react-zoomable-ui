!(function(e, t) {
  ...
  (function() {
    ...
    (h.pick = g(function(n, r) {
      ...
      (h.isEmpty = function(n) {
        return (
          null == n ||
          (w(n) && (h.isArray(n) || h.isString(n) || h.isArguments(n)) ? 0 === n.length : 0 === h.keys(n).length)
        );
      }),
  ...
  (function(t) {
    ...
    (a.off = function(t, e, i) {
      return (
        this._events && (this._events = u(f, this._events, t, e, { context: i, listeners: this._listeners })), this
      );
    }),
        ...
        if (null != t) {
          ...
          if (
            (s.length && E
              ...
              : a.length &&
                (v && (d = !0), x(this.models, a, null == r ? this.length : r), (this.length = this.models.length)),
    ...
    (B.started = !1),
      i.extend(B.prototype, a, {
        ...
        getFragment: function(t) {
          return (
            null == t && (t = this._usePushState || !this._wantsHashChange ? this.getPath() : this.getHash()),
            t.replace(J, '')
          );
        },
        start: function(t) {
        ...
        checkUrl: function(t) {
          ...
          if (
            (e === this.fragment && this.iframe && (e = this.getHash(this.iframe.contentWindow)), e === this.fragment)
          )
            return !1;
